            ...
            switch (opcion) {
                ...
                case 4:
                    ...
                    switch (opcion6) {
                        ...
                        case 3:
                            ...
                            if (bandera) {
                                for (int i = 0; i < 10; i++) {
                                    ...
                                    int ubi = Integer.parseInt(JOptionPane.showInputDialog("De cual sala desea eliminar la reserva"));
                                    ubi--;
                                    cine1[ubi].eliminarReserva();

                                    //Movemos las reservaciones a la izquerda movemos la null al final
                                    for (int j = ubi; i < contadorSalas - 1; j++) {
                                        cine1[j] = cine1[j + 1];
                                    }
                                    //Borramos la reservacion y tmb reducimos cantidad de reservaciones 
                                    cine1[contadorSalas - 1] = null;
                                    contadorSalas--;
                                }
                        ...
                        case 5:
                            int opcion19 = Integer.parseInt(JOptionPane.showInputDialog("desea añadir otro trabajador: \n 1.Si    2.No"));
                            if (opcion19 == 1) {
                                //se piden los valores para agregar al constructor
                                String nom = JOptionPane.showInputDialog("ingrese el nombre del nuevo trabajador");
                                String trabajo = JOptionPane.showInputDialog("ingrese el puesto de trabajo del nuevo trabajador");
                                String ID = JOptionPane.showInputDialog("ingrese el ID del nuevo trabajador");
                                trabajador1[num] = new Trabajador(nom, trabajo, ID);
                                num++;
                                break;
