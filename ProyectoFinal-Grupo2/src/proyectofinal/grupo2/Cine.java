...
public class Cine {
    ...
    public void eliminarReserva() {
        ...
        while (bandera) {
            mostrarSalas();
            String fila = JOptionPane.showInputDialog("Cual es la fila que desea desocupar");
            int columna = Integer.parseInt(JOptionPane.showInputDialog("Cual es el numero de columna que quiere desocupar")) - 1;
            int seleccion = 0;
            fila = fila.toUpperCase();
            switch (fila) {
                case "A":
